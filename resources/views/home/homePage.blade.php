...
<head>
    ...
    <link rel="stylesheet" href="template/css/app.css" >
     <link rel="stylesheet" href="template/css2/bootstrap.min.css" >
    <link rel="stylesheet" href="template/css2/style.css">
    <link rel="stylesheet" href="template/css2/tiny-slider.css">
</head>
...
<body>
    ...
    <section id="section_origin" class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="template/img/about-pic.jpg">
            ...
            <div class="hero__items set-bg" data-setbg="template/img/hero/ZZ.jpg">
                <div class="hero__text">
                    <h2>Quality is not only our standard.</h2>
                    <a href="#" class="primary-btn">See Project</a>
                    <a href="#" class="more_btn">Discover more</a>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
						<a class="product-item" href="cart.html">
							<img src="template/img/about-pic.jpg" class="img-fluid product-thumbnail">
                ...
                <div class="col-lg-6">
                    <div class="about__pic">
                        <div class="about__pic__inner">
                            <img src="template/img/dd.jpeg" alt="">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="project__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="project__slider__item set-bg" data-setbg="template/img/project/project-2.jpg">
                            <div class="project__slider__item__hover">
                                <span>interiors</span>
                                <h5>Lower River Street Astoria</h5>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="project__slider__item set-bg" data-setbg="template/img/project/project-3.jpg">
                            <div class="project__slider__item__hover">
                                <span>interiors</span>
                                <h5>Lower River Street Astoria</h5>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="project__slider__item set-bg" data-setbg="template/img/project/project-4.jpg">
                            <div class="project__slider__item__hover">
                                <span>interiors</span>
                                <h5>Lower River Street Astoria</h5>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services__item">
                        <img src="template/img/services/services-1.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services__item">
                        <img src="template/img/services/services-2.png" alt="">
                        <h4>Office Design</h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services__item">
                        <img src="template/img/services/services-3.png" alt="">
                        <h4>Home Design</h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services__item">
                        <img src="template/img/services/services-4.png" alt="">
    ...
    <section class="testimonial spad set-bg" data-setbg="template/img/testimonial/testimonial-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title">
                    ...
                    <div class="testimonial__client">
                        <div class="testimonial__client__item add">
                            <div class="testimonial__client__pic">
                                <img src="template/img/testimonial/ta-1.png" alt="">
                            </div>
                        ...
                        <div class="testimonial__client__item">
                            <div class="testimonial__client__pic">
                                <img src="template/img/testimonial/ta-2.png" alt="">
                            </div>
                            <div class="testimonial__client__text">
                                <h5>Renee Calhoun</h5>
                                <span>CEO Woolley</span>
                        ...
                        <div class="testimonial__client__item">
                            <div class="testimonial__client__pic">
                                <img src="template/img/testimonial/ta-3.png" alt="">
                            </div>
                            <div class="testimonial__client__text">
                                <h5>Renee Calhoun</h5>
                                <span>CEO Woolley</span>
                        ...
                        <div class="testimonial__client__item">
                            <div class="testimonial__client__pic">
                                <img src="template/img/testimonial/ta-4.png" alt="">
                            </div>
                            <div class="testimonial__client__text">
                                <h5>Renee Calhoun</h5>
                                <span>CEO Woolley</span>
                        ...
                        <div class="testimonial__client__item">
                            <div class="testimonial__client__pic">
                                <img src="template/img/testimonial/ta-5.png" alt="">
                            </div>
                            <div class="testimonial__client__text">
                                <h5>Renee Calhoun</h5>
                                <span>CEO Woolley</span>
                ...
                <div class="col-lg-12">
                    <div class="logo__carousel owl-carousel">
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-1.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-2.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-3.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-4.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-5.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="template/img/logo/logo-3.png" alt=""></a>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="team__item set-bg" data-setbg="template/img/team/team-1.jpg">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team__item set-bg" data-setbg="template/img/team/team-2.jpg">
                        <div class="team__text">
                            <div class="team__title">
                                <h5>Dana Vaughn</h5>
                                <span>Architect</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team__item set-bg" data-setbg="template/img/team/team-3.jpg">
                        <div class="team__text">
                            <div class="team__title">
    ...
    <section class="callto spad set-bg" data-setbg="template/img/call-bg.jpg">
        <div class="container">
            <div class="row d-flex justify-content-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="latest__item">
                        <div class="latest__item__pic">
                            <img src="template/img/blog/latest-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="latest__item">
                        <div class="latest__item__pic">
                            <img src="template/img/blog/latest-2.jpg" alt="">
                        </div>
                        <div class="latest__item__text">
                            <span>Interior</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="latest__item">
                        <div class="latest__item__pic">
                            <img src="template/img/blog/latest-3.jpg" alt="">
                        </div>
                        <div class="latest__item__text">
                            <span>Planning</span>
...
<!-- 2 JS -->
<script type="text/javascript" src="template/style/js/jquery.1.11.1.js"></script>
<script type="text/javascript" src="template/style/js/bootstrap.js"></script>
<script type="text/javascript" src="template/style/js/SmoothScroll.js"></script>
<script type="text/javascript" src="template/style/js/nivo-lightbox.js"></script>
<script type="text/javascript" src="template/style/js/jquery.isotope.js"></script>
<script type="text/javascript" src="template/style/js/jqBootstrapValidation.js"></script>
<script type="text/javascript" src="template/style/js/contact_me.js"></script>
<script type="text/javascript" src="template/style/js/main.js"></script>
</body>
